...
from examples.unicycle.start_to_goal.nominally_controlled.ukf_state_estimation import (
    initial_conditions,
)
...
if plot:
    ...
    animate(
        ...
        save_animation=save,
        animation_filename="examples/unicycle/start_to_goal/nominally_controlled/ukf_state_estimation/results/test.gif",
    )
