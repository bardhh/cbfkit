...
if __name__ == "__main__":
    ...
    completion_times = [result[7] if result[6] else None for result in results]
    ...
    if setup.VISUALIZE:
        ...
        for trial_no in range(setup.n_trials):
            animate(
                ...
                animation_filename="examples/single_integrator/ra_fxt_clf/perfect_state_measurements/results/test",
            )
