...
from examples.single_integrator.ra_fxt_clf.ukf_state_estimation import setup
    ...
    if setup.VISUALIZE:
        ...
        for trial_no in range(setup.n_trials):
            animate(
                ...
                animation_filename="examples/single_integrator/ra_fxt_clf/ukf_state_estimation/results/test",
            )
