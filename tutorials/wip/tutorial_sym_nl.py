...
from sympy import Matrix, cos, diff, lambdify, sin, symbols
...
for idxi, i in enumerate(xx):
    for idxk, k in enumerate(yy):
        ...
        t, y, x = control.input_output_response(
            sys=nimble_car_sys, T=T, U=0, X0=[i, k, 0], return_x=True, method="BDF"
        )
