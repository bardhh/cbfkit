...
dist_text.set_text(
    "dist(||x - [10 0]^T||< 5, t = 15) = " + "{:.2f}".format(dist_to_goal[find_nearest(T, 15)])
)
dist_text_3 = ax2.text(
    0.2, 1.10, "F_[5,15](||x - [10 0]^T||< 5)", transform=ax2.transAxes, fontsize=12
)

# plot patch of halfspace x bellow 0
patch_x_below_0 = plt.Rectangle((0, 5), 20, -10, color="g", alpha=0.2)
