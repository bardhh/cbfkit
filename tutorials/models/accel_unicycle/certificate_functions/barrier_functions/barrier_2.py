...
def cbf(l: float, **kwargs) -> Callable[[Array], Array]:
...
def cbf_grad(l: float, **kwargs) -> Callable[[Array], Array]:
...
def cbf_hess(l: float, **kwargs) -> Callable[[Array], Array]:
    ...
    """
    hessian = jacrev(jacfwd(cbf(l, **kwargs)))
