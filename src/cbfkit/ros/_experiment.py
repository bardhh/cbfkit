...
def stepper(
    ...
    """Build a single-step estimator/controller update callable for ROS experiments."""
...
def experimenter(
    ...
    """Build an iterator that runs the ROS experiment for a fixed number of steps."""
...
def experiment(
    ...
    """Run the full ROS experiment loop and collect trajectories plus auxiliary logs."""
    # Define simulator
