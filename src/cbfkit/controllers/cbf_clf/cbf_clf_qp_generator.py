...
from ._setup import _normalize_certificate_collection, validate_configuration
    ...
    def generate_cbf_clf_controller(
        ...
        **kwargs: Any,
        ...
        validate_configuration(
            control_limits, slack_penalty_cbf, slack_penalty_clf, slack_bound_cbf, slack_bound_clf
        )
