"""
consolidated_cbf_clf_qp_controller.py
================

Defines the controller function for a consolidated CBF-CLF-QP control law for known, deterministic,
continuous-time, control-affine, nonlinear dynamical systems.

Functions
---------
-consolidated_cbf_clf_qp_controller: generates the function to compute the control solution to the consolidated CBF-CLF-QP
...
>>> from cbfkit.controllers.model_based.cbf_clf_controllers import stochastic_cbf_clf_qp_controller
>>> 
...
consolidated_cbf_clf_qp_controller: CbfClfQpGenerator = cbf_clf_qp_generator(
    generate_compute_consolidated_cbf_constraints,
    generate_compute_vanilla_clf_constraints,
)
